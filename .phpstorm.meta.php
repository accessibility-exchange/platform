...
namespace PHPSTORM_META {
    ...
    override(new \Illuminate\Contracts\Container\Container, map([
        ...
        'Laravel\Fortify\Contracts\FailedTwoFactorLoginResponse' => \App\Http\Responses\FailedTwoFactorLoginResponse::class,
        ...
        'ParagonIE\CipherSweet\CipherSweet' => \ParagonIE\CipherSweet\CipherSweet::class,
        ...
        'Spatie\SqlCommenter\SqlCommenter' => \Spatie\SqlCommenter\SqlCommenter::class,
        'Spatie\Translatable\Translatable' => \Spatie\Translatable\Translatable::class,
        'Staudenmeir\LaravelMergedRelations\Facades\Schema' => \Staudenmeir\LaravelMergedRelations\Schema\Builders\MySqlBuilder::class,
        'Staudenmeir\LaravelMigrationViews\Facades\Schema' => \Staudenmeir\LaravelMigrationViews\Schema\Builders\MySqlBuilder::class,
        'Whoops\Handler\HandlerInterface' => \Spatie\LaravelIgnition\Renderers\IgnitionWhoopsHandler::class,
        'Worksome\RequestFactories\Contracts\Actions\CreatesFactoryResult' => \Worksome\RequestFactories\Actions\CreateFactoryResult::class,
        'Worksome\RequestFactories\Contracts\Actions\MergesFactoryIntoRequest' => \Worksome\RequestFactories\Actions\MergeFactoryIntoRequest::class,
        'Worksome\RequestFactories\Contracts\Finder' => \Worksome\RequestFactories\Support\ConfigBasedFinder::class,
        'Worksome\RequestFactories\FactoryManager' => \Worksome\RequestFactories\FactoryManager::class,
        ...
        'localizator' => \Amirami\Localizator\Services\Localizator::class,
        'localizator.collector.default' => \Amirami\Localizator\Services\Collectors\DefaultKeyCollector::class,
        'localizator.collector.json' => \Amirami\Localizator\Services\Collectors\JsonKeyCollector::class,
        'localizator.writers.default' => \Amirami\Localizator\Services\Writers\DefaultWriter::class,
        'localizator.writers.json' => \Amirami\Localizator\Services\Writers\JsonWriter::class,
