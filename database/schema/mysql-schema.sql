...
CREATE TABLE `connectables` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `individual_id` bigint unsigned NOT NULL,
  `connectable_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `defined_terms` (
  ...
  `defineable_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `engagements` (
  ...
  `recruitment` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `unit_suite_floor` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `locality` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `region` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `postal_code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `directions` json DEFAULT NULL,
  `meeting_software` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `meeting_phone` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `individuals` (
  ...
  `connection_lived_experience` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `other_payment_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `other_access_need` json DEFAULT NULL,
  `signed_language_for_interpretation` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `spoken_language_for_interpretation` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `signed_language_for_translation` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `written_language_for_translation` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `street_address` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `unit_apartment_suite` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `postal_code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `invitations` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `type` enum('individual','organization') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `matching_strategies` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `matchable_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `organizations` (
  ...
  `staff_lived_experience` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `preferred_contact_method` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'email',
  `preferred_contact_language` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `preferred_notification_method` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'email',
...
CREATE TABLE `users` (
  ...
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'individual',
  ...
  `support_person_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `support_person_email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `support_person_phone` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `support_person_vrs` tinyint(1) DEFAULT NULL,
  `preferred_contact_person` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'me',
  `preferred_contact_method` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'email',
  `preferred_notification_method` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'email',
  `notification_settings` json DEFAULT NULL,
  `extra_attributes` json DEFAULT NULL,
...
/*!50001 VIEW `all_individual_contracted_projects` AS select `projects`.`id` AS `id`,`projects`.`created_at` AS `created_at`,`projects`.`updated_at` AS `updated_at`,`projects`.`published_at` AS `published_at`,`projects`.`projectable_type` AS `projectable_type`,`projects`.`projectable_id` AS `projectable_id`,`projects`.`ancestor_id` AS `ancestor_id`,`projects`.`languages` AS `languages`,`projects`.`name` AS `name`,`projects`.`goals` AS `goals`,`projects`.`scope` AS `scope`,`projects`.`regions` AS `regions`,`projects`.`out_of_scope` AS `out_of_scope`,`projects`.`start_date` AS `start_date`,`projects`.`end_date` AS `end_date`,`projects`.`outcome_analysis` AS `outcome_analysis`,`projects`.`outcome_analysis_other` AS `outcome_analysis_other`,`projects`.`outcomes` AS `outcomes`,`projects`.`public_outcomes` AS `public_outcomes`,`projects`.`team_size` AS `team_size`,`projects`.`team_has_disability_or_deaf_lived_experience` AS `team_has_disability_or_deaf_lived_experience`,`projects`.`team_trainings` AS `team_trainings`,`projects`.`seeking_consultant` AS `seeking_consultant`,`projects`.`consultant_name` AS `consultant_name`,`projects`.`individual_consultant_id` AS `individual_consultant_id`,`projects`.`organizational_consultant_id` AS `organizational_consultant_id`,`projects`.`consultant_responsibilities` AS `consultant_responsibilities`,`projects`.`contact_person_name` AS `contact_person_name`,`projects`.`contact_person_email` AS `contact_person_email`,`projects`.`contact_person_phone` AS `contact_person_phone`,`projects`.`contact_person_vrs` AS `contact_person_vrs`,`projects`.`preferred_contact_method` AS `preferred_contact_method`,`projects`.`contact_person_response_time` AS `contact_person_response_time`,`projects`.`estimate_requested_at` AS `estimate_requested_at`,`projects`.`estimate_returned_at` AS `estimate_returned_at`,`projects`.`estimate_approved_at` AS `estimate_approved_at`,`projects`.`agreement_received_at` AS `agreement_received_at`,`projects`.`estimate_or_agreement_updated_at` AS `estimate_or_agreement_updated_at`,`engagements`.`individual_connector_id` AS `laravel_foreign_key`,'App\\Models\\Project' AS `laravel_model`,'' AS `laravel_placeholders`,'' AS `laravel_with` from (`projects` join `engagements` on((`engagements`.`project_id` = `projects`.`id`))) */;
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (33,'2022_07_28_300000_create_identities_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (34,'2022_07_28_300000_create_impacts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (35,'2022_07_28_300000_create_indigenous_identities_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (36,'2022_07_28_300000_create_languages_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (37,'2022_07_28_300000_create_lived_experiences_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (38,'2022_07_28_300000_create_meetings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (39,'2022_07_28_300000_create_payment_types_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (40,'2022_07_28_300000_create_phases_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (41,'2022_07_28_300000_create_sectors_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (42,'2022_07_28_300000_create_topics_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (43,'2022_07_28_400000_create_access_support_individual_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (44,'2022_07_28_400000_create_age_bracket_organization_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (45,'2022_07_28_400000_create_area_type_organization_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (46,'2022_07_28_400000_create_blockables_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (47,'2022_07_28_400000_create_connectables_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (48,'2022_07_28_400000_create_constituency_individual_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (49,'2022_07_28_400000_create_constituency_organization_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (50,'2022_07_28_400000_create_consulting_method_individual_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (51,'2022_07_28_400000_create_disability_type_organization_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (52,'2022_07_28_400000_create_engagement_individual_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (53,'2022_07_28_400000_create_engagement_organization_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (54,'2022_07_28_400000_create_ethnoracial_identity_organization_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (55,'2022_07_28_400000_create_formattables_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (56,'2022_07_28_400000_create_gender_identity_organization_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (57,'2022_07_28_400000_create_identity_individual_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (58,'2022_07_28_400000_create_identity_organization_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (59,'2022_07_28_400000_create_impact_organization_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (60,'2022_07_28_400000_create_impact_project_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (61,'2022_07_28_400000_create_indigenous_identity_organization_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (62,'2022_07_28_400000_create_individual_identity_connections_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (63,'2022_07_28_400000_create_individual_impact_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (64,'2022_07_28_400000_create_individual_language_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (65,'2022_07_28_400000_create_individual_lived_experience_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (66,'2022_07_28_400000_create_individual_payment_type_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (67,'2022_07_28_400000_create_individual_sector_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (68,'2022_07_28_400000_create_language_organization_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (69,'2022_07_28_400000_create_lived_experience_organization_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (70,'2022_07_28_400000_create_notificationables_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (71,'2022_07_28_400000_create_organization_sector_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (72,'2022_07_28_400000_create_phaseables_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (73,'2022_07_28_400000_create_projects_of_interest_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (74,'2022_07_28_400000_create_regulated_organization_sector_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (75,'2022_07_28_400000_create_resource_resource_collection_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (76,'2022_07_28_400000_create_topicables_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (77,'2022_07_28_500000_create_all_individual_contracted_projects_view',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (78,'2022_07_28_500000_create_all_organization_contracted_projects_view',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (79,'2022_09_06_180755_add_attributes_to_engagements_table_and_modify_required_columns',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (80,'2022_09_07_003406_add_contractual_fields_to_projects_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (81,'2022_09_13_125950_add_type_column_to_invitations_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (82,'2022_09_13_173553_create_notifications_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (83,'2022_09_19_123825_add_estimate_or_agreement_updated_at_column_to_projects_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (84,'2022_09_23_013753_update_engagements_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (85,'2022_09_28_150051_update_meetings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (86,'2022_10_13_131410_remove_projects_of_interest_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (87,'2022_10_13_145652_add_shared_access_needs_column_to_engagement_individual_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (88,'2022_10_13_171523_add_anonymizable_column_to_access_supports_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (89,'2022_10_18_002212_drop_engagement_organization_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (90,'2022_10_18_002311_add_organization_id_column_to_engagements_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (91,'2022_10_18_153227_update_user_privacy_policy_and_terms_of_service',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (92,'2022_10_19_161516_drop_media_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (93,'2022_10_24_121706_remove_team_languages_column_from_projects_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (94,'2022_10_24_140206_add_oriented_at_column_to_regulated_organizations_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (95,'2022_10_24_174535_add_suspended_at_columns_to_various_tables',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (96,'2022_11_01_173407_create_courses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (97,'2022_11_01_175858_create_modules_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (98,'2022_11_01_175924_create_quizzes_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (99,'2022_11_01_180656_create_questions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (100,'2022_11_01_195858_create_course_user_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (101,'2022_11_02_002440_create_interpretations_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (102,'2022_11_02_045232_create_module_user_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (103,'2022_11_02_045319_create_quiz_user_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (104,'2022_11_08_181911_change_type_user_sign_language_translations',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (105,'2022_11_08_203439_drop_formattables_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (106,'2022_11_08_203780_drop_formats_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (107,'2022_11_08_204008_add_formats_column_to_resources_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (108,'2022_11_09_122702_drop_phaseables_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (109,'2022_11_09_122719_drop_phases_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (110,'2022_11_09_122754_add_phases_column_to_resources_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (111,'2022_11_09_125102_drop_consulting_method_individual_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (112,'2022_11_09_125235_drop_consulting_methods_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (113,'2022_11_09_125556_add_consulting_methods_column_to_individuals_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (114,'2022_11_09_184522_drop_employment_statuses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (115,'2022_11_10_181232_create_choices_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (116,'2022_11_17_181722_remove_signed_language_columns_from_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (117,'2022_11_18_135707_update_translatable_slugs',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (118,'2022_11_24_200740_create_language_matching_strategy_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (119,'2022_11_24_202938_create_identity_matching_strategy_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (120,'2022_11_28_151526_drop_redundant_identity_tables',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (121,'2022_11_29_001847_update_columns_in_resources_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (122,'2022_11_29_004006_create_impact_resource_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (123,'2022_11_29_004030_create_resource_sector_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (124,'2022_11_29_005942_drop_topicables_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (125,'2022_11_29_010044_create_resource_topic_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (126,'2022_11_29_150313_add_clusters_column_to_identities_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (127,'2022_12_02_013944_rename_other_disability_type_connection_column_on_individuals_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (128,'2022_12_05_191025_rename_other_disability_type_column_on_organizations_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (129,'2022_12_05_203758_rename_column_on_organizations_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (130,'2022_12_06_141502_add_cross_disability_and_deaf_column_to_matching_strategies_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (131,'2022_12_08_193312_drop_value_column_from_choices_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (132,'2022_12_09_192148_add_organization_id_column_to_resources_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (133,'2022_12_10_210658_update_description_column_in_resource_collections_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (134,'2022_12_11_201445_remove_user_id_column_from_resource_collections_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (135,'2022_12_14_083707_create_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (136,'2022_12_21_184920_remove_finished_at_from_course_user_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (137,'2023_01_25_202134_drop_choices_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (138,'2023_01_26_043044_add_choices_and_correct_choices_columns_to_questions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (139,'2023_01_27_015926_create_question_quiz_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (140,'2023_01_27_025738_remove_quiz_id_from_questions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (141,'2023_02_06_213028_drop_attempts_column_from_quiz_user_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (142,'2023_02_14_185236_remove_order_column_from_questions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (143,'2023_02_14_190146_add_order_column_to_quizzes_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (144,'2023_02_14_205104_add_author_column_to_courses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (145,'2023_02_27_135909_add_slug_column_courses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (146,'2023_02_27_143224_add_slug_column_modules_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (147,'2023_04_18_114553_add_description_to_impacts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (148,'2023_05_01_180138_create_general_settings',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (149,'2023_05_01_201239_add_registration_links_to_general_settings',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (150,'2023_05_09_132308_add_dismiss_customization_status_to_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (151,'2023_05_09_141054_add_dismiss_invite_status_to_organizations_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (152,'2023_05_09_141124_add_dismiss_invite_status_to_regulated_organizations_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (153,'2023_06_07_000001_create_pulse_tables',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (154,'2023_07_11_220402_migrate_slug_column_to_json_courses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (155,'2023_07_11_220419_migrate_slug_column_to_json_modules_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (156,'2023_07_12_140339_migrate_to_json_author_column_courses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (157,'2023_07_19_145806_remove_completed_at_column_module_user_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (158,'2023_10_16_174255_update_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (159,'2023_10_17_142724_remove_route_has_params_column_from_interpretations',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (160,'2023_10_25_150457_create_pages_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (161,'2023_11_17_145037_remove_registration_links_to_general_settings',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (162,'2023_11_17_150202_readd_registration_links_to_general_settings',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (163,'2024_01_31_191956_add_privacy_email_to_general_settings',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (164,'2024_02_01_180830_drop_communication_tools_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (165,'2024_02_06_143126_add_preferred_contact_language_to_projects_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (166,'2024_02_06_190129_add_preferred_contact_language_to_organizations_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (167,'2024_02_06_190140_add_preferred_contact_language_to_regulated_organizations_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (168,'2024_04_11_190038_consolidate_application_links_in_general_settings',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (169,'2024_10_28_191140_localize_settings',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (170,'2024_11_18_184830_update_address_in_general_settings',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (171,'2025_06_09_165833_create_documents_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (172,'2025_06_09_165844_create_revisions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (173,'2025_06_13_140451_create_libraries_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (174,'2025_06_13_143720_create_library_resource_collection_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (175,'2025_06_19_122757_add_order_column_column_to_libraries_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (176,'2025_06_19_123243_add_order_column_column_to_resource_collections_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (177,'2025_06_19_131508_add_featured_column_to_resource_collections_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (178,'2025_06_19_131517_add_featured_column_to_libraries_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (179,'2025_06_23_152120_create_tools_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (180,'2025_06_23_161358_add_tool_id_column_to_documents_table',1);
