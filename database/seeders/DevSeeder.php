    ...
    public function run(): void
    {
        ...
        $individualsForTesting = [
            [
                ...
                'genderIdentities' => [], 'constituencies' => ['Refugee or immigrant'],
                ...
                'individualDetails' => [
                    ...
                    'consulting_services' => [
                        'booking-providers', 'planning-consultation', 'writing-reports',
                    ],
                    'lived_experience' => ['en' => 'Knows from lived experience as a person who has used a wheelchair for more than 2 decades how the built environment can either restrict or enable independence and fulfillment.'],
                    'skills_and_strengths' => ['en' => 'Delivered extensive workshops and presentations in-person and virtually on the topic of accessible design and universal design and is an advocate for making our built environment more accessible.'],
                    'website_link' => 'https://www.Mysite.com',
                    'bio' => ['en' => 'As a person with living experiences of mobility disabilities, I have advocated for a barrier free envirnment for the past two decades. have conducted accessibility audits of interior and exterior spaces; providing workshops on built environment accessibility, barrier free and universal design; performing policy audits; conducting needs assessments and other research; and preparing community report cards on issues affecting people with disabilities.'],
                    'meeting_types' => [
                        'in_person', 'web_conference', 'phone',
                    ],
            ...
            [
                ...
                'genderIdentities' => [], 'constituencies' => ['Trans person'],
                'indigenousIdentities' => [],
                'areaTypes' => [
                    'Urban areas',
                ], 'disabilityTypes' => [
                ...
                'individualDetails' => [
                    ...
                    'lived_experience' => ['en' => 'I have been born Deaf and attended regular school and faced all the challenges that many other people in the Deaf community have to encouter to fit in. I am a member of the Trans community in Halifax.  '],
                    'skills_and_strengths' => ['en' => 'I have been part of many different focus groups and advisory committees to make provincial services and programs more accessible and inclusive for the Deaf as well as the 2SLGBTQIA+ community. '],
                    'bio' => ['en' => 'As a Deaf trans person I can bring in unique intersections of experinces to any conversation revolving around the issues of accessibility and inclusion. I have been one of the few people leading the inclusion and equaity efforts in my region. '],
                    'meeting_types' => [
                        'in_person', 'web_conference', 'phone',
                    ],
                    'connection_lived_experience' => 'yes-all',
            ...
            [
                ...
                'genderIdentities' => [], 'constituencies' => [],
                ...
                'individualDetails' => [
                    ...
                    'consulting_services' => [
                        'running-consultation', 'writing-reports',
                    ],
                    'lived_experience' => ['en' => 'I am a Mohawk (Kanienkehaka) person from Akwesasne who is a member of the Bear clan. I have been supporting my community members who face mental health and subtance use and addiction for the past 12 years. '],
                    'skills_and_strengths' => ['en' => 'Personal support worker'],
                    'bio' => ['en' => 'I have been advocating for Indigenous with mental health and addiction since the 80s. '],
                    'meeting_types' => [
                        'in_person', 'web_conference', 'phone',
                    ],
            ...
            [
                ...
                'genderIdentities' => ['Gender fluid person', 'Gender non-conforming person', 'Non-binary person'], 'constituencies' => ['2SLGBTQIA+ person'],
                'indigenousIdentities' => [],
                'areaTypes' => [
                    'Urban areas',
                ], 'disabilityTypes' => [
                ...
                'individualDetails' => [
                    ...
                    'lived_experience' => ['en' => 'I am middle aged queer individual. I have become blind in my early 20s and since then I have learned to use braille. '],
                    'skills_and_strengths' => ['en' => 'Addiction support worker'],
                    'bio' => ['en' => 'I have been advocating for building safer work environments for the 2SLGBTQIA+ community in Quebec for the past five years. I have conducted many workshops, presentations, and websinars to help employers from local businesses to large corporations to rethink their current practices and make their work space more welcoming for the queer and Trans employees. '],
                    'meeting_types' => [
                        'in_person', 'web_conference', 'phone',
                    ],
                    'connection_lived_experience' => 'yes-some',
            ...
            [
                ...
                'individualDetails' => [
                    ...
                    'lived_experience' => ['en' => 'I have supported both my parents who suffered from dementia later in life. '],
                    'skills_and_strengths' => ['en' => 'Many years of working directly with individuals in the disability community who also have inetrsecting identities.  '],
                    'website_link' => 'https://www.Mysite.com',
                    'bio' => ['en' => 'I am a second generation Chinese who is advocating for senior immigrants who may suffer from alzheimers and dementia '],
                    'meeting_types' => [
                        'in_person', 'web_conference', 'phone',
                    ],
                    'connection_lived_experience' => 'yes-some',
            ...
            [
                ...
                'froDetails' => [
                    ...
                    'accessibility_and_inclusion_links' => [[
                        'title' => 'Our path towards accessibility and inclusion',
                    ...
                    'preferred_contact_method' => 'email',
                    'about' => ['en' => 'We are a Canadian airline headquartered in Hamilton Ontario. We operate short range domestic flights to different Canadian major cities. '],
                ],
            ],
            [
                'name' => 'Murlio Durado',
                ...
                'froDetails' => [
                    ...
                    'accessibility_and_inclusion_links' => [[
                        'title' => 'Making food and agriculture sector accessible',
                        'url' => 'https://example.com',
                    ]],
                    'website_link' => 'https://example.com',
                    ...
                    'preferred_contact_method' => 'email',
                    'about' => ['en' => 'Agriculture and Agri-Food Canada supports the Canadian agriculture and agri-food sector through initiatives that promote innovation and competitiveness.'],
                ],
            ],
            [
                'name' => 'Ali Selim',
                ...
                'froDetails' => [
                    ...
                    'accessibility_and_inclusion_links' => [[
                        'title' => 'Accessibility at Canada Post',
                        'url' => 'https://example.com',
                    ]],
                    'website_link' => 'https://example.com',
        ...
        foreach ($frosForTesting as $froUser) {
            ...
            $fro = RegulatedOrganization::factory()->hasAttached($user, ['role' => 'admin'])->create($froData);
