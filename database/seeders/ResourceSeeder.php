        ...
        if (false && Storage::disk('seeds')->exists(sprintf('resources.%s.json', $environment))) {
            ...
            $resources = [
                [
                    ...
                    'impacts' => [Impact::firstWhere('name->en', 'The design and delivery of programs and services')->id, Impact::firstWhere('name->en', 'Communication, other than information and communication technologies')->id],
                    'topics' => [],
