...
namespace Illuminate\Http {
        ...
        class Request
        {
            ...
            public static function localizedRouteIs(...$patterns)
            {
                return self::localizedRouteIs(...$patterns);
            }
        }
...
namespace Illuminate\Routing {
        ...
        class Router
        {
            ...
            public static function multilingual($key, $handle = null, $locales = [])
            {
                return self::multilingual($key, $handle, $locales);
            }
        }
        ...
        class Redirector
        {
            ...
            public static function localizedRoute($route, $parameters = [], $status = 302, $headers = [])
            {
                return self::localizedRoute($route, $parameters, $status, $headers);
            }
        }
...
namespace Makeable\QueryKit\Builder {
        ...
        class Builder
        {
            ...
            {
                return self::whereBetween(...$parameters);
            }
            ...
            {
                return self::whereDate(...$parameters);
            }
            ...
            {
                return self::whereDay(...$parameters);
            }
            ...
            {
                return self::whereMonth(...$parameters);
            }
            ...
            {
                return self::whereIn(...$parameters);
            }
            ...
            {
                return self::whereNull(...$parameters);
            }
            ...
            {
                return self::whereNotBetween(...$parameters);
            }
            ...
            {
                return self::whereNotIn(...$parameters);
            }
            ...
            {
                return self::whereNotNull(...$parameters);
            }
            ...
            {
                return self::whereTime(...$parameters);
            }
            ...
            {
                return self::whereYear(...$parameters);
            }
            ...
            {
                return self::whereColumn(...$parameters);
            }
        }
