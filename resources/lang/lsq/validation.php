...
return [
    ...
    */
    ...
    'filled' => 'Le champ :attribute ne peut être vide.',
    'gt' => [
    ...
    'prohibits' => 'Le champ :attribute n\'est pas utilisable quand :other est sélectionné.',
    'prohibited' => 'L\'utilisation du champ :attribute est interdite.',
    'prohibited_if' => 'L\'utilisation du champ :attribute est interdite quand :other a la valeur :value.',
    'prohibited_unless' => 'L\'utilisation du champ :attribute est interdite à moins que :other soit l\'une des valeurs :values.',
    ...
    */
    ...
    'custom' => [
        ...
        'story' => [
            'title_exists' => 'Une histoire portant ce titre existe déjà.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'phone' => __('numéro de téléphone'),
        'support_person_email' => __('adresse courriel de la personne fournissant du soutien'),
        'support_person_phone' => __('numéro de téléphone de la personne fournissant du soutien'),
        'contact_person_email' => __('adresse courriel de la personne contact'),
        'contact_person_phone' => __('numéro de téléphone de la personne contact'),
    ],
