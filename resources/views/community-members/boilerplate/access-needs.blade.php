...
<x-heading :level="$level">For contacting {{ $communityMember->firstName() }}</x-heading>
...
<x-heading :level="$level">For notifying {{ $communityMember->firstName() }} of new projects</x-heading>
