<form action="{{ localized_route('individuals.update-communication-and-meeting-preferences', $individual) }}" method="POST" enctype="multipart/form-data" novalidate>
    @csrf
    @method('PUT')
        ...
        <div class="stack">
            ...
            <div class="stack" x-data="{contactPerson: '{{ old('preferred_contact_person', $individual->preferred_contact_person ?? 'me') }}'}">
                <fieldset>
                    ...
                    <x-hearth-radio-buttons name="preferred_contact_person" :options="['me' => __('Me'), 'support-person' => __('My support person')]" :checked="old('preferred_contact_person', $individual->preferred_contact_person ?? 'me')" x-model="contactPerson" />
                </fieldset>
