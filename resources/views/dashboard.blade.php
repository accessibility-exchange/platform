<x-app-layout page-width="wide">
    ...
    @if (
        !Auth::user()->checkStatus('dismissedCustomizationPrompt') ||
    ...
    @if (Auth::user()->regulatedOrganization && !Auth::user()->regulatedOrganization->checkStatus('dismissedInvitePrompt'))
        <livewire:prompt :model="Auth::user()->regulatedOrganization" modelPath="dismissed_invite_prompt_at" :heading="__('Invite others to your organization')" :interpretationName="__('Invite others to your organization', [], 'en')"
