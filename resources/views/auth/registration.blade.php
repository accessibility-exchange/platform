<x-guest-layout>
    <x-auth-card>
        ...
        <p><a href="{{ localized_route('register', ['context'=> 'consultant']) }}">{{ __('I am here to share my knowledge about disability') }} <x-heroicon-s-arrow-right aria-hidden="true" style="display: inline-block; margin-right: 0.25em; margin-bottom: -0.125em; width: 1em; height: 1em;" /></a></p>
