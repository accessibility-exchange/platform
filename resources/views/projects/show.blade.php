<x-app-wide-layout>
    ...
    <x-slot name="header">
        ...
        <p><strong>{!! __('Accessibility project by :entity', ['regulatedOrganization' => '<a href="' . localized_route('regulated-organizations.show', $project->regulatedOrganization) . '">' . $project->regulatedOrganization->name . '</a>']) !!}</strong></p>
