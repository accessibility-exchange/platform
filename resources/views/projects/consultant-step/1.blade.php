<div class="flow">
    ...
    <div class="box flow">
        ...
        <p>
            <a class="button" href="#">
                {{ __('View') }} <span class="visually-hidden">{{ __('Detailed project fact sheet – :language', ['language' => get_locale_name('en', locale())]) }}</span>
            </a> <a class="button" href="#">
                {{ __('Download') }} <span class="visually-hidden">{{ __('Detailed project fact sheet – :language', ['language' => get_locale_name('en', locale())]) }}</span>
            </a>
        </p>
        <h4>{{ __('Detailed project fact sheet – :language', ['language' => get_locale_name('fr', locale())]) }}</h4>
        <p>{{ __('Description of this document.') }}</p>
        <p>
            <a class="button" href="#">
                {{ __('View') }} <span class="visually-hidden">{{ __('Detailed project fact sheet – :language', ['language' => get_locale_name('fr', locale())]) }}</span>
            </a> <a class="button" href="#">
                {{ __('Download') }} <span class="visually-hidden">{{ __('Detailed project fact sheet – :language', ['language' => get_locale_name('fr', locale())]) }}</span>
            </a>
        </p>
        <h4>{{ __('Project contract – :language', ['language' => get_locale_name('en', locale())]) }}</h4>
        <p>{{ __('Description of this document.') }}</p>
        <p>
            <a class="button" href="#">
                {{ __('View') }} <span class="visually-hidden">{{ __('Project contract – :language', ['language' => get_locale_name('en', locale())]) }}</span>
            </a> <a class="button" href="#">
                {{ __('Download') }} <span class="visually-hidden">{{ __('Project contract – :language', ['language' => get_locale_name('en', locale())]) }}</span>
            </a>
        </p>
        <h4>{{ __('Project contract – :language', ['language' => get_locale_name('fr', locale())]) }}</h4>
        <p>{{ __('Description of this document.') }}</p>
        <p>
            <a class="button" href="#">
                {{ __('View') }} <span class="visually-hidden">{{ __('Project contract – :language', ['language' => get_locale_name('fr', locale())]) }}</span>
            </a> <a class="button" href="#">
                {{ __('Download') }} <span class="visually-hidden">{{ __('Project contract – :language', ['language' => get_locale_name('fr', locale())]) }}</span>
            </a>
        </p>
    </div>
</div>
