...
<ol role="list" class="flow">
    <li>
        <p>{{ __('Learn how to engage the Deaf and disability communities.') }}</p>
        ...
        @else
        <p><x-heroicon-s-check-circle class="icon" width="24" height="24" /> Done</p>
        <form method="post" action="{{ localized_route('projects.update-progress', $project) }}">
            @csrf
            @method('PUT')
    ...
    <li>
        <p>{{ __('Think about how to structure your consultation.') }}</p>
    ...
    <li>
        <p>{{ __('Learn about how the disability community is currently engaging with your organization or sector.') }}</p>
    ...
    <li>
        <p>{{ __('Learn about different ways to meet access needs.') }}</p>
