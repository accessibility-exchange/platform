    ...
    <ul role="list" class="flow">
        ...
        <li class="flow">
            <div class="field @error("work_and_volunteer_experiences.{$i}.title") field--error @enderror">
                <x-hearth-label :for="'work_and_volunteer_experiences_title_' . $i" :value="__('Title of role')" />
                <x-hearth-input :id="'work_and_volunteer_experiences_title_' . $i" :name="'work_and_volunteer_experiences[' . $i . '][title]'" :value="$experience['title']" />
            ...
            <div class="field @error("work_and_volunteer_experiences.{$i}.start_year") field--error @enderror">
                ...
                <x-hearth-input type="number" :id="'work_and_volunteer_experiences_start_year_' . $i" :name="'work_and_volunteer_experiences[' . $i . '][start_year]'" :value="$experience['start_year']" />
            ...
            <div class="field @error("work_and_volunteer_experiences.{$i}.end_year") field--error @enderror">
                ...
                <x-hearth-input type="number" :id="'work_and_volunteer_experiences_end_year_' . $i" :name="'work_and_volunteer_experiences[' . $i . '][end_year]'" :value="$experience['end_year'] ?? ''" />
