<div class="center center:wide columns">
    <div class="column stack">
        <div class="stack">
            ...
            @if(($user->individual->isConsultant() || $user->individual->isConnector()) && !$user->individual->hasAddedDetails())
            <x-expander level="3">
                ...
                <div class="stack">
                    ...
                    <p>
                        <a href="{{ localized_route('individuals.edit', $user->individual) }}" class="cta secondary">{{ __('Create your page') }}</a>
                    </p>
                </div>
            </x-expander>
            @else
        ...
        <div class="stack">
            <h2>{{ __('My page') }}</h2>
            <p>
                <a href="{{ localized_route('individuals.show', ['individual' => $user->individual]) }}"><strong>{{ __('Visit my page') }}</strong>@if($user->individual->checkStatus('draft')) ({{ __('draft') }})@endif</a><br />
                <a href="{{ localized_route('individuals.edit', ['individual' => $user->individual]) }}">{{ __('Edit my page') }}</a>
            </p>
        </div>
