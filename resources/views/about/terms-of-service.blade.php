    ...
    <div class="stack">
        ...
        <ol class="stack" type="a">
            <li>{!! Str::inlineMarkdown(
                __(
                    '“**Accessibility Consultant**” means an individual or organization helping Project Proponents design, facilitate and complete their Projects.',
                ),
            ) !!}</li>
            <li>{!! Str::inlineMarkdown(
                __(
                    '“**Community Connector**” means an individual or organization helping connect communities to Project Proponents seeking knowledge about how to connect with and/or support the community or Consultation Participants.',
                ),
            ) !!}</li>
            <li>{!! Str::inlineMarkdown(
                __(
                    '“**Consultation Participant**” means an individual or organization participating in consultations hosted by Project Proponents.',
                ),
            ) !!}</li>
            <li>{!! Str::inlineMarkdown(
                __(
                    '“**Consultants**” means an Accessibility Consultant, Community Connector, or Consultation Participants, as the context may require.',
                ),
            ) !!}</li>
            <li>{!! Str::inlineMarkdown(
                __(
            ...
            <li>{!! Str::inlineMarkdown(__('“**FRO**” has the meaning set out in the opening paragraph of these Terms.')) !!}</li>
            <li>{!! Str::inlineMarkdown(__('“**Indemnitees**” has the meaning set out in Section 12(a) of these Terms.')) !!}</li>
            <li>{!! Str::inlineMarkdown(__('“**IRIS Trademarks**” has the meaning set out in Section 9(b) of these Terms.')) !!}</li>
            <li>{!! Str::inlineMarkdown(
                __(
                    '“**Project**” means any engagement to develop an accessibility plan or to undertake other activities to improve accessibility, between a Consultant and a Project Proponent pursuant to a Project Agreement.',
                ),
            ) !!}</li>
            <li>{!! Str::inlineMarkdown(__('“**Project Agreement**” has the meaning set out in Section 2(b) of these Terms.')) !!}</li>
            <li>{!! Str::inlineMarkdown(
                __('“**Registration Information**” has the meaning set out in Section 3(a) of these Terms.'),
            ) !!}</li>
            <li>{!! Str::inlineMarkdown(__('“**Service Content**” has the meaning set out in Section 9(a) of these Terms.')) !!}</li>
            <li>{!! Str::inlineMarkdown(__('“**Services**” has the meaning set out in the opening paragraph of these Terms.')) !!}</li>
            <li>{!! Str::inlineMarkdown(__('“**Submissions**” has the meaning set out in Section 10(c) of these Terms.')) !!}</li>
            <li>{!! Str::inlineMarkdown(__('“**Third Party Content**” has the meaning set out in Section 8(a) of these Terms.')) !!}</li>
            <li>{!! Str::inlineMarkdown(
                __('“**Third Party Provider**” has the meaning set out in Section 8(a) of these Terms.'),
            ) !!}</li>
            <li>{!! Str::inlineMarkdown(__('“**Third Party Service**” has the meaning set out in Section 8(b) of these Terms.')) !!}</li>
            <li>{!! Str::inlineMarkdown(__('“**Third Party Terms**” has the meaning set out in Section 8(b) of these Terms.')) !!}</li>
            <li>{!! Str::inlineMarkdown(__('“**Underaged Person**” has the meaning set out in Section 3(a) of these Terms.')) !!}</li>
            <li>{!! Str::inlineMarkdown(__('“**Upload**” means to upload, post or publish on the Platform.')) !!}</li>
            <li>{!! Str::inlineMarkdown(
                __(
                    '“**User**” or “**you**” means a Project Proponent or Consultant, as the circumstances may indicate or require. ',
                ),
            ) !!}</li>
        ...
        <ol class="stack" type="a">
            <li class="stack">
                {!! Str::markdown(__('**The Platform is a Venue.** The Platform serves as a venue that:')) !!}
                <ol type="i">
        ...
        <ol class="stack" type="a">
            ...
            <li>{!! Str::inlineMarkdown(
                __(
                    '**Invoices.** IRIS will invoice Project Proponents the annual subscription amount owed to access and use the Platform. Project Proponents hereby agree to pay any undisputed amounts to IRIS within 30 days of such invoice.',
                ),
            ) !!}</li>
            <li>{!! Str::inlineMarkdown(
                __(
        ...
        <ol class="stack" type="a">
            <li>{!! Str::inlineMarkdown(
                __(
                    '**Use of the Platform.** IRIS authorizes You to access and use the Platform solely for the purpose of searching, accessing, downloading and reviewing Platform content (in print, audio, video or other provided format) for informational purposes only and solely for your own use.',
                ),
            ) !!}</li>
            <li>{!! Str::inlineMarkdown(
                __(
        ...
        <ol class="stack" type="a">
            <li>{!! Str::inlineMarkdown(
                __(
                    '**Term.** This Agreement will continue for a term of 12 months and automatically renew at the end of such period, subject to your continued payment of any subscription amounts owed.',
                ),
            ) !!}</li>
            <li>{!! Str::inlineMarkdown(
                __(
            ...
            <li>
                {!! Str::markdown(
                    __(
                        '**Other Termination.** IRIS reserves the right to terminate these Terms, suspend or terminate User’s access to the Platform and/or any Services with or without notice, or deactivate or delete your account including all related information to User for any reason, including:',
                    ),
                ) !!}
                <ol class="stack" type="i">
        ...
        <ol class="stack" type="a">
            ...
            <li>{!! Str::inlineMarkdown(
                __(
                    '**Language.**  It is the express wish of the parties hereto that the Terms be drawn up in English. The parties hereto hereby waive any right to use and rely upon any other language.',
                ),
            ) !!}</li>
            <li>{!! Str::inlineMarkdown(
                __(
            ...
            <li>{!! Str::inlineMarkdown(
                __(
                    '**Assignment.** You may not assign these Terms without the prior written consent of IRIS, but IRIS may assign or transfer these Terms, in whole or in part, without restriction.',
                ),
            ) !!}</li>
            <li>{!! Str::inlineMarkdown(
                __(
            ...
            <li>{!! Str::inlineMarkdown(
                __(
                    '**Waiver.** No failure or delay by IRIS in exercising any right hereunder will waive any further exercise of that right.',
                ),
            ) !!}</li>
            <li>{!! Str::inlineMarkdown(
                __(
