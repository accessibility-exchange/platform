<x-app-wide-layout>
    ...
    <x-slot name="header">
        <ol class="breadcrumbs" role="list">
            ...
            <li><a
                    href="{{ localized_route('about.individual-consultation-participants') }}">{{ __('Consultation Participants') }}</a>
            </li>
        </ol>
            ...
            <div class="stack">
                ...
                <x-expander :summary="__('Lived or living experience')" level="3">
                    ...
                    <ul>
                        ...
                        <li>{{ __('Whether they consider themselves to be living in poverty or financially precarious') }}
                        </li>
                    </ul>
                    ...
                    <p>{{ __('In order to create a successful exchange, we ask Consultation Participants to provide this information so that The Accessibility Exchange can match Consultation Participants with an engagement that is looking for someone with your experiences.') }}
                    </p>
                </x-expander>
