        ...
        <div class="with-sidebar">
            ...
            <div class="stack">
                ...
                <x-expander :summary="__('Communities you can connect to')" level="3">
                    ...
                    <h4>{{ __('Why do we ask for this information?') }}</h4>
                    <p>{{ __('Regulated organizations hire a Community Connector to connect to certain communities that they may otherwise find difficult to reach. Providing the information about the communities that you have connections to, lets the government and business groups know how you could help them.') }}</p>
                </x-expander>
                ...
                <x-expander :summary="__('Communication and meeting preferences')" level="3">
                    ...
                    <h4>{{ __('Why do we ask for this information?') }}</h4>
                    <p>{{ __('This information will help governments and businesses communicate and work with you in a format that is accessible to you.') }}</p>
