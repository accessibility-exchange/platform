    ...
    <div class="stack">
        ...
        <div class="stack cards cards--collections">
            ...
            <div class="box card card--collection stack">
                ...
                <p class="actions"><a class="button" href="{{ localized_route('resource-collections.show', $resourceCollection)}}" aria-describedby="{{ Str::slug($resourceCollection->title) }}">{{ __('Visit resources') }}</a></p>
            </div>
            @endforeach
        </div>
