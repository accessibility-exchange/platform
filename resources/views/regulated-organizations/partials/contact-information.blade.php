...
@if ($regulatedOrganization->contact_person_email)
    <x-contact-point type="email" :value="$regulatedOrganization->contact_person_email"
        preferred="{{ $regulatedOrganization->preferred_contact_method === App\Enums\ContactMethod::Email->value && $regulatedOrganization->contact_person_phone }}" />
@endif
@if ($regulatedOrganization->contact_person_phone)
    <x-contact-point type="phone" :value="$regulatedOrganization->contact_person_phone"
        preferred="{{ $regulatedOrganization->preferred_contact_method === App\Enums\ContactMethod::Phone->value && $regulatedOrganization->contact_person_email }}"
