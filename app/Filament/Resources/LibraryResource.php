...
class LibraryResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->filters([])
            ->actions([
                Tables\Actions\EditAction::make()->tooltip(fn (Library $record): string => __('Edit :title', ['title' => $record->title])),
                Tables\Actions\ViewAction::make()->url(fn (Library $record): string => localized_route('libraries.show', $record))->tooltip(fn (Library $record): string => __('Edit :title', ['title' => $record->title])),
            ])
            ->bulkActions([
