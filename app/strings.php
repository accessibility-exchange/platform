...
return [
    ...
    '2.0 Projects' => [
        ...
        'Projects/Browse all projects' => [
            ...
            __('Vision including blind, partially sighted'),
            __('Deaf people'),
            __('Hard-of-hearing'),
            __('Physical and mobility'),
            __('Pain'),
            __('Communication'),
            __('Neurodivergence'),
            __('Developmental'),
            ...
            __('Episodic and invisible disabilities'),
            __('DeafBlind'),
            __('Body differences including size, limb and facial differences'),
            __('Temporary disabilities'),
            __('Other disability'),
            __('Supporters'),
            __('Virtual or in-person'),
            __('Virtual - video chat'),
        ...
        'Manage project/Participant selection criteria/specific disability' => [
            ...
            __('Visual including sight loss, blind, and partially sighted'),
            __('Deaf'),
            __('Pain-related'),
            __('(such as chronic fatigue syndrome)'),
            __('(includes individuals with no spoken or signed language who communicate using gestures, pictures, letter boards, communication devices or assistance from a person who knows them well)'),
            __('(such as Autism, ADHD)'),
            __('(includes intellectual disability)'),
            __('(such as dyslexia)'),
            __('(includes traumatic brain injury, memory difficulties, dementia)'),
            __('Mental health-related'),
            __('(such as dual diagnosis of a mental health barrier, substance dependence)'),
            __('(such as environmental, HIV, migraine)'),
            ...
            __('Visual (including sight loss, blind, and partially sighted)'),
            __('Women'),
            __('Non-binary, gender non-conforming, gender fluid'),
        ],
        ...
        'Manage engagement/open call/participants-access needs' => [
            ...
            __('Braille version of engagement documents'),
            __('Printed version of engagement documents'),
            __('Need someone to call and walk through information'),
            __('Large text'),
            __('Plain language'),
            __('Reminders (for events or for submitting engagement documents)'),
            __('Audio versions of engagement documents'),
        ...
        'Manage engagement/open call/demographic breakdown' => [
            ...
            __('Disabilities included'),
            __(':percentage of your participants have more than one disability.'),
            __('Visual'),
            __('Hard of hearing'),
            __('Body, limb, and facial differences'),
            __('Temporary'),
            __('Other identities included'),
            __(':percentage of your participants identify with more than one of the following.'),
            __('Gender non-binary, non-conforming, or fluid'),
            __('2SLGBTQIA+'),
            __('Trans'),
            __('Black'),
            __('Asian'),
            __('Middle Eastern'),
            __('White'),
            __('Temporary residents, immigrants, and refugees'),
            __('Single parents'),
            __('Unemployed or underemployed'),
            __('Financially precarious'),
    ...
    '3.0 People and organizations' => [
        ...
        'Explore/AC' => [
            ...
            __('Broadcasting'),
            __('Federal government programs and services'),
            __('Crown corporation'),
            __('Employment'),
            __('Buildings and public spaces'),
            __('Information and communication technology'),
            __('Communication, other than information and communication technologies'),
            __('Buying goods and services'),
            __('Providing programs and services'),
        ],
        ...
        'Explore/CC' => [
            ...
            __('Non-binary, gender non-conforming, gender fluid people'),
            __('Trans people'),
            __('Immigrants and refugees'),
            __('Language groups they can connect to'),
            __('Age groups they can connect to'),
            __('Children (under 15)'),
            __('Youth (15-30)'),
            __('Working age adults (15-64)'),
            __('Older people (65+)'),
        ],
    ...
    '4.0 Resources' => [
        ...
        // https://www.figma.com/file/AXufBnFAVHvGdsxnQMVhNF/The-Accessibility-Exchange-Wireframes?node-id=2858%3A76096
        'Resources/audio' => [
            __('Audio'),
        ],
    ...
    '5.1 Member pages' => [
        ...
        'Consultant Community Connector / create profile - 9' => [
            ...
            __('Cross-disability'),
            __('Specific disability or disabilities'),
