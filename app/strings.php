...
return [
    ...
    'Platform admin' => [
        ...
        'Notifications' => [
            ...
            __('Manage participants for this engagement'),
            ...
            __('You are now able to publish your page.'),
            __('You can now sign up for projects.'),
            __('Orientation completed'),
            __('You have completed your orientation session.'),
            __('You are now able to publish your page and take part in consultations.'),
            __('Orientation completed'),
            __('You have completed your orientation session.'),
