...
class ParticipantLeft extends PlatformNotification
{
    ...
    public function toMail(Project $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject(__('1 participant left :engagement', ['engagement' => $this->engagement->getTranslation('name', locale())]))
            ->line(__('1 participant left :engagement', ['engagement' => $this->engagement->getTranslation('name', locale())]).'.')
    ...
    public function toVonage(Project|Organization|User $notifiable): VonageMessage
    {
        return (new VonageMessage)
            ->content(
                __('1 participant left :engagement', ['engagement' => $this->engagement->getTranslation('name', locale())]).'. '.__(
