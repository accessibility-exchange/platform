...
class UpdateOrganizationConstituenciesRequest extends FormRequest
{
    ...
    public function attributes(): array
    {
        return [
            ...
            'lived_experience_constituencies' => __('lived experience constituencies'),
            'lived_experience_constituencies.*' => __('lived experience constituencies'),
            'base_disability_type' => __('disability type'),
            'disability_and_deaf_constituencies' => __('disability and deaf constituencies'),
            'disability_and_deaf_constituencies.*' => __('disability and deaf constituencies'),
            'has_other_disability_constituency' => __('has other disability constituency'),
            'other_disability_constituency' => __('other disability constituency'),
            'other_disability_constituency.*' => __('other disability constituency'),
            'area_type_constituencies' => __('area type constituencies'),
            'area_type_constituencies.*' => __('area type constituencies'),
            'has_indigenous_constituencies' => __('has indigenous constituencies'),
            'indigenous_constituencies' => __('indigenous constituencies'),
            'indigenous_constituencies.*' => __('indigenous constituencies'),
            'refugees_and_immigrants' => __('Refugees and/or immigrants'),
            'has_gender_and_sexuality_constituencies' => __('has gender and sexuality constituencies'),
            'gender_and_sexuality_constituencies' => __('gender and sexuality constituencies'),
            'gender_and_sexuality_constituencies.*' => __('gender and sexuality constituencies'),
            'nb_gnc_fluid_identity' => __('Non-binary/Gender non-conforming/Gender fluid identity'),
            'has_age_bracket_constituencies' => __('has age bracket constituencies'),
            'age_bracket_constituencies' => __('age bracket constituencies'),
            'age_bracket_constituencies.*' => __('age bracket constituencies'),
            'has_ethnoracial_identity_constituencies' => __('has ethnoracial identity constituencies'),
            'ethnoracial_identity_constituencies' => __('ethnoracial identity constituencies'),
            'ethnoracial_identity_constituencies.*' => __('ethnoracial identity constituencies'),
            'has_other_ethnoracial_identity_constituency' => __('has other ethnoracial identity constituency'),
            'other_ethnoracial_identity_constituency' => __('other ethnoracial identity constituency'),
            'other_ethnoracial_identity_constituency.*' => __('other ethnoracial identity constituency'),
            'language_constituencies' => __('language constituencies'),
            'language_constituencies.*' => __('language constituencies'),
            'staff_lived_experience' => __('Staff lived experience'),
        ];
    }
