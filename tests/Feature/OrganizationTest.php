...
test('user can request to join organization', function () {
    $user = User::factory()->create(['context' => 'organization']);
    $organization = Organization::factory()->create();
...
test('user with outstanding join request cannot request to join organization', function () {
    $user = User::factory()->create(['context' => 'organization']);
    $organization = Organization::factory()->create();
...
test('user with existing membership cannot request to join organization', function () {
    $user = User::factory()->create(['context' => 'organization']);
    $organization = Organization::factory()->create();
...
test('user can cancel request to join organization', function () {
    $user = User::factory()->create(['context' => 'organization']);
    $organization = Organization::factory()->create();
    $organization->requestsToJoin()->save($user);
...
test('admin can approve request to join organization', function () {
    $user = User::factory()->create(['context' => 'organization']);
